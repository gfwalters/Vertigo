Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   **Vertigo** is a simple image viewer which includes a **custom view controller transition** that mimics the new **iOS 7 Photos app** image zoom transition effect.
                   DESC
  s.homepage     = "https://github.com/gfwalters/Vertigo"
  s.screenshots  = "https://raw.github.com/gfwalters/Vertigo/master/VertigoSample/VertigoSample.gif"
  s.license      = 'MIT'
  s.author       = { 'Guillermo Gonzalez' => 'gonzalezreal@icloud.com' }
  s.platform     = :ios, '7.0'
  s.source       = { :git => "https://github.com/gfwalters/Vertigo.git", :tag => "0.1" }
